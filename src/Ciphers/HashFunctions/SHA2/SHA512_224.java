...
public class SHA512_224 implements HashFunction {
    ...
    private long h0 = 0x8C3D37C819544DA2L;
    private long h1 = 0x73E1996689DCD4D6L;
    private long h2 = 0x1DFAB7AE32FF9C82L;
    private long h3 = 0x679DD514582F9FCFL;
    private long h4 = 0x0F6D2B697BD44DA8L;
    private long h5 = 0x77E36F7304C48942L;
    private long h6 = 0x3F9D85A86A1D36C8L;
    private long h7 = 0x1112E6AD91D692A1L;
    ...
    public byte[] process(byte[] input) {
        ...
        for (int i = 0; i < input_prepared.length; i += 128) {
            ...
            for (int j = 16; j < i_num; j++) {
                s0 = (BitUtil.BitRotation.rotateR(words_64bit[j - 15], 1)) ^ (BitUtil.BitRotation.rotateR(words_64bit[j - 15], 8)) ^ (words_64bit[j - 15] >>> 7);
                s1 = (BitUtil.BitRotation.rotateR(words_64bit[j - 2], 19)) ^ (BitUtil.BitRotation.rotateR(words_64bit[j - 2], 61)) ^ (words_64bit[j - 2] >>> 6);
            ...
            for (int q = 0; q < i_num; q++) {
                ...
                long S0 = (BitUtil.BitRotation.rotateR(a, 28)) ^ (BitUtil.BitRotation.rotateR(a, 34)) ^ (BitUtil.BitRotation.rotateR(a, 39));
                long S1 = (BitUtil.BitRotation.rotateR(e, 14)) ^ (BitUtil.BitRotation.rotateR(e, 18)) ^ (BitUtil.BitRotation.rotateR(e, 41));
        ...
        byte[] hash_512 = BitUtil.ByteArrays.longArrayToByteArray(
                new long[]{
                        h0,
                        h1,
                        h2,
        ...
        this.reset();
        byte[] hash_224 = new byte[28];
        System.arraycopy(hash_512,0,hash_224,0,hash_224.length);
        return hash_224;
    }

    @Override
    public void reset() {
        h0 = 0x8C3D37C819544DA2L;
        h1 = 0x73E1996689DCD4D6L;
        h2 = 0x1DFAB7AE32FF9C82L;
        h3 = 0x679DD514582F9FCFL;
        h4 = 0x0F6D2B697BD44DA8L;
        h5 = 0x77E36F7304C48942L;
        h6 = 0x3F9D85A86A1D36C8L;
        h7 = 0x1112E6AD91D692A1L;
    }
